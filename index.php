...
<body style="background: slategray">
    <form action="<?php $_SERVER['PHP_SELF']?>" method="post">
        ...
        <input value="/Users/paulholsters/mouldit-test-project-1/server" id="path-to-root-server-folder" name="path-to-root-server-folder">
        <label for="path-to-root-client-folder">
            Enter path of client root folder
        </label>
        <input value="/Users/paulholsters/mouldit-test-project-1/client" id="path-to-root-client-folder" name="path-to-root-client-folder">
