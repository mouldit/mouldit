...
Mouldit only works with an edgeDB project. It will use the types that can be found in your edgeQL schema to determine all possible server actions. <a href="edgedb.com">Here</a> you can find information on how to create an edgeDB project and the neceassry schema. <a href="mouldit.io">Here</a> you can find an example on how such a schema and the CLI work together to create your application.
