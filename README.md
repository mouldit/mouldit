...
<p>Although the goal is to make the CLI so that you don't need to add any custom code afterwards to your application, this will only be achieved gradually. As Mouldit grows the amount of actions will get bigger as well as the level of detail to which you can configure these actions. What the frontend concerns, there it will be the amount of UI components and their details.</p>
